...
The `tableone`-package is dedicated for generating this type of statistics. It has slightly more advanced design allowing you to extract variables of a single type together with a few other features. It currently lacks html-output and I've therefore added integration with the `htmlTable` function.
